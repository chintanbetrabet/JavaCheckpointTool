...
public class JarHandler {
    ...
    public static void writeJar(CtClass cc, ClassPool pool, String jarName) {
        ...
        try {
            ...
            //jarHandler.
            jarHandler.replaceJarFile(jarName, b, saveName);
            pool = ClassPool.getDefault();
            try {
                pool.insertClassPath(jarName);
            } catch (NotFoundException ex) {
                Logger.getLogger(JarHandler.class.getName()).log(Level.SEVERE, null, ex);
            }
